...
const SignupSchema = Yup.object().shape({
  ...
  confirmPassword: Yup.string().required('Confirm your password').oneOf([Yup.ref('password')], 'Password alag hai bhai')
})
...
const Signup = () => {
  ...
  return (
    <div className="mt-7 mx-auto w-1/3 bg-gray-400 border-gray-200 rounded-xl shadow-2xs dark:bg-black-200 dark:border-neutral-700">
